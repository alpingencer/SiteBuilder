...
class ListComponent extends SortableTableComponent {
	...
	public function getContent(): string {
		...
		if(empty($this->primaryKey)) $this->primaryKey = $database->getPrimaryKey($this->tableDatabaseName);
	...
	/**
	 * Resets the primary database key to the SiteBuilder default value '';
	 *
	 * @return self Returns itself for chaining other functions
	 * @see ListComponent::$primaryKey
	 */
